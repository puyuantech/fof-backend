...
from bases.validation import FOFValidation


class RiskDiscloseValidation(FOFValidation):
...
class FundContractValidation(FOFValidation):
    """sync with InvestorContract"""
...
class ProtocolValidation(FOFValidation):
    """sync with InvestorContract"""
...
class FundMatchingValidation(FOFValidation):
    """sync with InvestorContract"""
...
class VideoValidation(FOFValidation):
    """sync with InvestorContract"""
...
class LookbackValidation(FOFValidation):
    """sync with InvestorContract"""
...
class BookValidation(FOFValidation):
    """sync with InvestorContract"""
