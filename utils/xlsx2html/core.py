...
from utils.xlsx2html.compat import OPENPYXL_24
from utils.xlsx2html.constants.border import DEFAULT_BORDER_STYLE, BORDER_STYLES
from utils.xlsx2html.format import format_cell
...
def xlsx2html(filepath=None, wb=None, output=None, locale='en',
