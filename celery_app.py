...
schedule_config = {
    'CELERYBEAT_SCHEDULE': {
        'clean_celery_log': {
            'task': 'utils.celery_tasks.clean_celery_log',
...
class CusTask(Task):
    ...
    def __call__(self, *args, **kwargs):
        ...
        log_obj.save()
        return super(CusTask, self).__call__(*args, **kwargs)
    ...
    def on_success(self, retval, task_id, args, kwargs):
        ...
        return super(CusTask, self).on_success(retval, task_id, args, kwargs)
    ...
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        ...
        return super(CusTask, self).on_failure(exc, task_id, args, kwargs, einfo)


celery = Celery(flask_app.import_name, task_cls=CusTask)
